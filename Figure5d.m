...
%%% It is also used to reproduce panels c and d of Ext. Data Fig. 8.
...
%%% (generated by compute_logistic_regression_all_ephys_rats.m)
...
for iii=1:length(rat_names)
    ...
    plot_neur_new(rat,'location');




    subplot(4,7,21+ind_freq(iii))
    plot_neur_new(rat,'frequency');
